...
export function Player() {
  const { currentMusic, setCurrentMusic, isPlaying, setIsPlaying, volume, isOnRepeat, setIsOnRepeat } = usePlayerStore(
    state => state
  );
  ...
  useEffect(() => {
    ...
    isPlaying ? audioRef.current.play().catch(e => console.error('error playing: ', e)) : audioRef.current.pause();
  }, [isPlaying]);
